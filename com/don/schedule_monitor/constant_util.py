...
MONITOR_DATA_SELECT_FORMAT = """SELECT job_id, job_name, param, table_name, table_type, check_status FROM result_target_log where check_status = 0 limit 1;"""

MONITOR_DATA_SELECT_COUNT_FORMAT = """SELECT count(1) FROM result_target_log where check_status = 1;"""
